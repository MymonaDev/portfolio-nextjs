...
AnimatedBeam.displayName = "AnimatedBeam"; // Add this line
...
>(({ children }, ref) => {
  return (
    <div
      ref={ref}
      className={
        "z-10 flex  items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_1.25rem_-0.75rem_rgba(0,0,0,0.8)]"
      }
    >
      {children}
    </div>
